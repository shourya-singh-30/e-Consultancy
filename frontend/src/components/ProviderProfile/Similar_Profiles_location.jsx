...
export default class Similar_Profiles_location extends React.Component {
  ...
  viewMore = () => {
    history.push(`/viewMore`, { criterion: this.state.cityData });
  };
    ...
    return (
      <div>
        <div style={{ width: "90%", marginLeft: "12px" }}>
          More Profiles from {this.props.rcn.replace("Others-", "")}&nbsp;
          <ChevronRightIcon />
        </div>
        <br />
