...
export default function HeaderLinks(props) {
  ...
  const [selectedFinancialType, setselectedFinancialType] = useState([
    "Banking",
  ]);
  ...
  useEffect(() => {
    ...
    if (
      localStorage.getItem("userProfile") === "true" ||
  ...
  return (
    <List className={classes.list}>
      <ListItem className={classes.listItem}>
        ...
        localStorage.getItem("providerProfile") ? null : (
          <CustomDropdown
            noLiPadding
            buttonText="Provider"
            buttonProps={{
      ...
      <ListItem className={classes.listItem}>
        ...
        localStorage.getItem("providerProfile") ? (
          <CustomDropdown
            noLiPadding
            buttonText={<React.Fragment>Welcome {name}</React.Fragment>}
            buttonProps={{
              className: classes.navLink,
              color: "transparent",
            }}
            buttonIcon={Apps}
            dropdownList={[
              <Link onClick={handleProfile} className={classes.dropdownLink}>
                View Profile
              </Link>,
              <Link onClick={navigate} className={classes.dropdownLink}>
                Dashboard
              </Link>,
              <Link onClick={logout} className={classes.dropdownLink}>
                Logout
              </Link>,
            ]}
          />
